...
# |                          *** DEFINE COMMAND ***                      | #
# ======================================================================== #
# check if it is singularity/slurm run
cmd=""
...
# continue defining the command
cmd+="python3 ${p_src_code}src/combine_networks/code/exclude_autoregulation_and_flatten_network.py \
