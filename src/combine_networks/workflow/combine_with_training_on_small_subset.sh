...
then
    ...
    cmd_select_training_sub_unsupported="${p_src_code}src/combine_networks/wrapper/select_training_testing_sets_for_small_subset.sh \
        --p_in_net_binding ${p_in_net_binding} \
        --l_in_name_net ${l_in_name_net} \
        --l_in_path_net $(create_paths ${l_in_name_net} net ${p_out_dir}supported/) \
        --seed ${seed} \
        --in_nbr_reg ${in_nbr_reg} \
        --p_out_dir ${p_out_dir}unsupported/data_train/ \
        --flag_slurm ${flag_slurm} \
        --flag_singularity ${flag_singularity} \
        --p_singularity_img ${p_singularity_img} \
        --p_singularity_bindpath ${p_singularity_bindpath} \
        ...
        --p_progress ${p_progress} \
        --flag_debug ${flag_debug}"
    eval ${cmd_select_training_sub_unsupported}
    ...
    cmd_train_test_unsupported+=" ${p_src_code}src/combine_networks/wrapper/train_test.sh \
        --p_in_binding_train ${p_out_dir}unsupported/data_train/net_binding.tsv \
...
then
    ...
    do
        ...
        # select a subset..
            cmd_select_training_sub_supported="${p_src_code}src/combine_networks/wrapper/select_training_testing_sets_for_small_subset.sh \
        --p_in_net_binding ${p_out_dir}supported/data_cv/fold${f}_train_binding.tsv \
        --l_in_name_net ${l_in_name_net} \
        --l_in_path_net $(create_paths ${l_in_name_net} fold${f}_train ${p_out_dir}supported/data_cv/) \
        --seed ${seed} \
        --in_nbr_reg ${in_nbr_reg} \
        --p_out_dir ${p_out_dir}supported/data_cv/data_train/ \
        --flag_slurm ${flag_slurm} \
        --flag_singularity ${flag_singularity} \
        --p_singularity_img ${p_singularity_img} \
        --p_singularity_bindpath ${p_singularity_bindpath} \
        ...
        --p_progress ${p_progress} \
        --flag_debug ${flag_debug}"
        eval ${cmd_select_training_sub_supported}
        ...
        cmd_train_test_supported+="${p_src_code}src/combine_networks/wrapper/train_test.sh \
            --p_in_binding_train ${p_out_dir}supported/data_cv/data_train/fold${f}_train_binding.tsv \
            --l_in_name_net ${l_in_name_net} \
