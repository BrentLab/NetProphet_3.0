generate_lasso_net = function(p_in_expr_target
  ...
  # ================================================================================================= #
  source(paste(p_src_code, "src/build_lasso/code/netprophet1/global.lars.regulators.r", sep=""))  # for generating lasso network
  source(paste(p_src_code, "src/build_lasso/code/prepare_data_generate_allowed_perturbed_and_scale_normalize.R", sep=""))  # for preparing data
  source(paste(p_src_code, "src/build_lasso/code/helper.R", sep=""))  # for helper functions
