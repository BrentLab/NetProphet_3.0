...
create_lasso_global_shrinkage_parallel = function(df_expr_target
  ...
  library("Rmpi", lib="/home/dabid/R/x86_64-pc-linux-gnu-library/3.4")
  #}
  ...
  mpi.remote.exec(source(paste(p_src_code, "code/netprophet1/run_netprophet_parallel_single_process.r", sep="")))
