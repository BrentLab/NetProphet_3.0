...
def main():
    ...
    parser.add_argument('--p_net_binding', '-p_net_binding', help='path of network for binding')
    parser.add_argument('--l_net_name', '-l_net_name', nargs='+', help='list of name of networks such as binding, lasso, de, etc')
    parser.add_argument('--l_p_net', '-l_p_net', nargs='+', help='list of paths of networks that names were provided in l_net_name')
    ...
    parser.add_argument('--nbr_reg', '-nbr_reg', type=int, help='integer: number of regulators that will be used for the training')
    
    args = parser.parse_args()
    
    select_write_training_testing_1_fold_cv(p_net_binding=args.p_net_binding
                                            , l_net_name=args.l_net_name
                                            , l_p_net=args.l_p_net
                                            , seed=args.seed
                                            , nbr_reg=args.nbr_reg
