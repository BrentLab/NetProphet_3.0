def split_networks_based_on_perturbed_reg(l_name_net
                                          , l_path_net
                                          , p_net_binding
                                          , p_out_dir
                                         ):
    ...
    p_net_de = [l_path_net[i] for i, net in enumerate(l_name_net) if net == 'de']
    if p_net_de:
        p_net_de = p_net_de[0]
...
def main():
    ...
    split_networks_based_on_perturbed_reg(l_name_net=args.l_name_net
