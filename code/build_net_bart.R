...
if (sys.nframe() == 0){
    ...
    # load local R
    source(paste(opt$p_src_code, "code/netprophet2/build_bart_network.r", sep=""))
    source(paste(opt$p_src_code, "code/prepare_data_generate_allowed_perturbed_and_scale_normalize.R", sep=""))
